...
export class sc_Reclaimer extends SceneBase {
  constructor(params) {
    ...
    let skyscraperTexture = new THREE.TextureLoader().load(
      "assets/Textures/GlassWindow/Glass_Window_003_basecolor.jpg"
    );
    let skyscraperNormal = new THREE.TextureLoader().load(
      "assets/Textures/GlassWindow/Glass_Window_003_normal.jpg"
    );

    let apartmentColor = new THREE.Color(0xd67229);
    let apartmentTexture = new THREE.TextureLoader().load(
    ...
    let skyScraperMaterial = new THREE.ShaderMaterial({
    ...
    apartmentMaterial.uniforms.lightDirection.value =
      reclaimerProperties.sunDirection;
    ...
    houseMaterial.uniforms.lightDirection.value =
      reclaimerProperties.sunDirection;
