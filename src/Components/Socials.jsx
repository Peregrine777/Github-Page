...
import FlexReveal from './FlexReveal';
...
const Socials = ({ darkMode }) => {
    ...
    return (
        <div>
                <FlexReveal style={{justifyContent: "center", alignItems:"center", marginTop:"2rem" }}>
                    <MinimalButton darkMode={darkMode} text="Résumé" onClick={() => window.open("assets/Files/Resume.pdf", "_blank")} />
